"""
Contour area detection and dry area percentage calculation for filter 04 small platform camera.
"""
...
filename = 'filter04_small_platform_dan_leftview.mp4'
...
vid_size = (1920, 1080)
recording_fps = 30.0
out = cv2.VideoWriter('output/filter04_small_platform_left_view_output.avi', fourcc, recording_fps, vid_size)
# out = cv2.VideoWriter('output/webcam_output.avi', fourcc, recording_fps, vid_size)

image_file = 'output/dry_area_graph.png'
# image_file = 'output/webcam_graph.png'
